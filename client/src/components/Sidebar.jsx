...
const Sidebar = () => {
  ...
  return (
    <div
      className={`bg-[#81858B]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${
      ...
      <div className="flex flex-col">
        {filteredUsers.map((user) => (
          <div
            ...
            className={`relative flex items-center justify-between p-3 rounded-xl cursor-pointer hover:bg-[#282142]/50 ${
